...
int TngPapyrus::UpdateLogLvl(RE::StaticFunctionTag*, int aLogLvl) {
  TngInis::SetLogLvl(aLogLvl < 0 ? aLogLvl : aLogLvl + spdlog::level::info);
  return int(TngInis::GetLogLvl()) - int(spdlog::level::info);
}

std::string TngPapyrus::ShowLogLocation(RE::StaticFunctionTag*) { 
